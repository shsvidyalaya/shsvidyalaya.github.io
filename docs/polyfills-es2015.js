...
/**
 * This file includes polyfills needed by Angular and is loaded before  app.
 * You can add your own extra polyfills to this file.
 *
 * This file is divided into 2 sections:
 *   1. Browser polyfills. se are applied before loading ZoneJS and are sorted by browsers.
 *   2. Application imports. Files imported after ZoneJS that should be loaded before your main
 *      file.
 *
 *  current setup is for so-called "evergreen" browsers;  last versions of browsers that
 * automatically update mselves. This includes Safari >= 10, Chrome >= 55 (including Opera),
 ...
 * BROWSER POLYFILLS
 */
/** IE10 and IE11 requires  following for NgClass support on SVG elements */
// import 'classlist.js';  // Run `npm install --save classlist.js`.
/**
 * Web Animations `@angular/platform-browser/animations`
 * Only required if AnimationBuilder is used within  application and using IE/Edge or Safari.
 ...
 * will put import in  top of bundle, so user need to create a separate file
 * in this directory (for example: zone-flags.ts), and put  following flags
 * into that file, and n add  following code before importing zone.js.
 * import './zone-flags.ts';
 *
 *  flags allowed in zone-flags.ts are listed here.
 *
 *  following flags will work for all browsers.
 *
 * (window as any).__Zone_disable_requestAnimationFrame = true; // disable patch requestAnimationFrame
 * (window as any).__Zone_disable_on_property = true; // disable patch onProperty such as onclick
 * (window as any).__zone_symbol__UNPATCHED_EVENTS = ['scroll', 'mousemove']; // disable patch specified eventNames
 *
 *  in IE/Edge developer tools,  addEventListener will also be wrapped by zone.js
 *  with  following flag, it will bypass `zone.js` patch for IE/Edge
 *
...
__webpack_require__(/*! D:\shs\src\polyfills.ts */"./src/polyfills.ts");
module.exports = __webpack_require__(/*! D:\shs\node_modules\@angular-devkit\build-angular\src\angular-cli-files\models\jit-polyfills.js */"./node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/jit-polyfills.js");
